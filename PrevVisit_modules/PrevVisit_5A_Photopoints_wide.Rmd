...
# update to current server path
photo_path <- paste0("./PROJECTS/MONITORING/Forest_Health/5_Data/Photos/Photopoints/", year, "/")
...
```{r echo = F, out.width = "75%", warnings = F, message = FALSE, fig.align = 'center', eval = photo_eval}
...
```{r echo = F, out.width = "98%", warnings = F, message = FALSE, eval = photo_eval}
